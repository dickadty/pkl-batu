...
@section('content')
    <div class="space-y-6">
        ...
        <x-admin.page-header title="Edit Kategori Informasi" description="Perbarui nama kategori dan sifat informasi publik."
            :breadcrumbs="[
                [
                    'label' => 'Dashboard',
        ...
        <div class="rounded-2xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-white/[0.03]">
            ...
            <form action="{{ route('admin.kategori-informasi.update', $kategori->id) }}" method="POST" class="space-y-6">
                ...
                {{-- Sifat --}}
                <div>
                    <label for="sifat" class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300">
                        Sifat Informasi
                        <span class="text-red-500">*</span>
                    </label>
                    ...
                    <select id="sifat" name="sifat" required
                        ...
                        <option value="berkala" @selected(old('sifat', $kategori->sifat) == 'berkala')>
                            Berkala
                        </option>

                        <option value="setiap_saat" @selected(old('sifat', $kategori->sifat) == 'setiap_saat')>
                            Setiap Saat
                        </option>

                        <option value="serta_merta" @selected(old('sifat', $kategori->sifat) == 'serta_merta')>
                            Serta Merta
                        </option>

                        <option value="dikecualikan" @selected(old('sifat', $kategori->sifat) == 'dikecualikan')>
                            Dikecualikan
                        </option>
                    </select>
